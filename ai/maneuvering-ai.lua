...
sgs.ai_use_priority.ThunderSlash = 2.7
...
sgs.ai_use_priority.FireSlash = 2.7
...
function SmartAI:searchForAnaleptic(slash,enemy)
	...
	for _,a in ipairs(self:getCard("Analeptic",true))do
		if a:isKindOf("SkillCard") and not sgs.Analeptic_IsAvailable(self.player) then continue end
