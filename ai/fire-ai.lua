...
-- 袁绍主公选将策略
sgs.ai_general_choice_for_lord["yuanshao"] = function(ai, generals, default_choice, lord)
...
-- 荀彧主公策略（节命：濒死时让别人摸牌）
sgs.ai_general_choice_for_lord["xunyu"] = function(ai, generals, default_choice, lord)
