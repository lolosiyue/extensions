...
public slots:
    ...
    void chooseOption(const QString &skillName, const QStringList &options, const QStringList &except_options, const QString &tip);
...
private:
    ...
    QMap<QString, QGraphicsProxyWidget *> m_namedPileWidgets; // Dynamic widgets for named piles
