...
public:
    ...
    virtual void setDescriptionSwap(const QString &player_name, const QString &key, const QString &value);
...
private:
    bool lord_skill;
    QStringList sources;
    QMultiMap<QString, QString> description_p2ks;
    QMap<QString, QString> description_kp2v;
};
